...
PATH = "./FinalSN/cache/ytsearch.json"
...
async def yt_search(FinalSN):
    try:
        FinalSN = urllib.parse.quote(FinalSN)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={FinalSN}"
        )
...
"""
async def yt_data(FinalSN):
    params = {"format": "json", "url": FinalSN}
