...
from . import final313, edit_delete, edit_or_reply, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m FinalSN`",
        "**State changed from starting to up**",
        "__INFO:FinalSN:Logged in as 557667062__",
        "__INFO:FinalSN:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
