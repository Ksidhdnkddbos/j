...
@final313.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular FinalSN",
    },
)
...
@final313.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}مودي <نص>",
        "examples": "{tr}مودي فـاينل الاصلي",
    },
)
async def nekobot(cat):
...
@final313.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular FinalSN",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@final313.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna FinalSN is One of the Popular FinalSN",
    },
)
async def nekobot(cat):
...
@final313.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; FinalSN is One of the Popular FinalSN",
    },
)
async def nekobot(cat):
