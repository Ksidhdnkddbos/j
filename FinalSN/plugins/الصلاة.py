#ترجمه فريق فـاينل على التيلكرام
import json

import requests
#ترجمه فريق فـاينل على التيلكرام
from ..sql_helper.globals import gvarstatus
from . import final313, edit_delete, edit_or_reply
...
async def get_adzan(adzan):
    ...
    final313result = f"<b>اوقـات صـلاه المـسلمين 👳‍♂️ </b>\
    ...
    "
    await edit_or_reply(adzan, final313result, "html")
