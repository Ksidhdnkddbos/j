...
@final313.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}رسالة @z3zz_z حي الله  ان",
    },
)
...
@final313.ar_cmd(pattern="ازالة التوجيه")
async def F16 (event):
    if event.message.reply_to_msg_id:
        ...
        if replied_msg.media:
            ...
            await final313.send_message(event.chat_id, "", file=replied_msg.media)
        else:
            
            await final313.send_message(chat_id=event.chat_id, message=replied_msg.message)
    else:
