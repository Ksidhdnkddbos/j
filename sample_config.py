...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/redaiq90/z3zz_z"
    )
    ...
    PMPERMIT_TEXT_Z3ZZ_Z = os.environ.get("PMPERMIT_TEXT_Z3ZZ_Z", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in z3zz_z
